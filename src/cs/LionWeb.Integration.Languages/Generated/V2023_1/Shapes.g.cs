...
public partial class BillOfMaterials : AnnotationInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.BillOfMaterials_defaultGroup.EqualsIdentity(feature))
		{
			...
			{
				DefaultGroup = (LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MaterialGroup?)value;
				return true;
			}
...
public partial class Geometry : ConceptInstanceBase, IPartitionInstance<INode>
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.Geometry_documentation.EqualsIdentity(feature))
		{
			...
			{
				Documentation = (LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value;
				return true;
			}
...
public partial class MaterialGroup : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.MaterialGroup_defaultShape.EqualsIdentity(feature))
		{
			...
			{
				DefaultShape = (LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.MaterialGroup_matterState.EqualsIdentity(feature))
		{
			...
			{
				MatterState = (LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MatterState?)value;
				return true;
			}
...
public partial class OffsetDuplicate : Shape
{
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_altSource.EqualsIdentity(feature))
		{
			...
			{
				AltSource = (LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Shape?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_docs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				Docs = (LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value;
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_secretDocs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				SecretDocs = (LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value;
				return true;
			}
 ...
 IShape IShape.SetUuid(string value) => SetUuid(value);
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (ShapesLanguage.Instance.Shape_shapeDocs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				ShapeDocs = (LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value;
				return true;
			}

...
#nullable enable
namespace LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2;
using LionWeb.Core;
...
public partial class BillOfMaterials : AnnotationInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (ShapesLanguage.Instance.BillOfMaterials_altGroups.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.BillOfMaterials_altGroups.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MaterialGroup>(value).ToList();
		...
		if (ShapesLanguage.Instance.BillOfMaterials_defaultGroup.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MaterialGroup)
			{
				SetDefaultGroup((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MaterialGroup?)value, notificationId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.BillOfMaterials_groups.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.BillOfMaterials_groups.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MaterialGroup>(value).ToList();
		...
		if (ShapesLanguage.Instance.BillOfMaterials_materials.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.BillOfMaterials_materials.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape>(value).ToList();
			AssureNotNull(safeNodes, ShapesLanguage.Instance.BillOfMaterials_materials);
			AssureNotNullMembers(safeNodes, ShapesLanguage.Instance.BillOfMaterials_materials);
...
public partial class Circle : Shape
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (ShapesLanguage.Instance.Circle_center.EqualsIdentity(feature))
		{
			if (value is LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Coord v)
			{
...
public partial class CompositeShape : Shape
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (ShapesLanguage.Instance.CompositeShape_disabledParts.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.CompositeShape_disabledParts.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape>(value).ToList();
		...
		if (ShapesLanguage.Instance.CompositeShape_evilPart.EqualsIdentity(feature))
		{
			if (value is LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape v)
			{
		...
		if (ShapesLanguage.Instance.CompositeShape_parts.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.CompositeShape_parts.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape>(value).ToList();
...
public partial class Geometry : ConceptInstanceBase, IPartitionInstance<INode>
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (ShapesLanguage.Instance.Geometry_documentation.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				SetDocumentation((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value, notificationId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.Geometry_shapes.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.Geometry_shapes.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape>(value).ToList();
...
public partial class MaterialGroup : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (ShapesLanguage.Instance.MaterialGroup_defaultShape.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape)
			{
				SetDefaultShape((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape?)value, notificationId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.MaterialGroup_materials.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.MaterialGroup_materials.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape>(value).ToList();
		...
		if (ShapesLanguage.Instance.MaterialGroup_matterState.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MatterState)
			{
				SetMatterState((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MatterState?)value, notificationId);
				return true;
			}
...
public partial class OffsetDuplicate : Shape
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_altSource.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Shape)
			{
				SetAltSource((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Shape?)value, notificationId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_docs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				SetDocs((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value, notificationId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_secretDocs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				SetSecretDocs((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value, notificationId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_source.EqualsIdentity(feature))
		{
			if (value is LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Shape v)
			{
...
public partial class ReferenceGeometry : ConceptInstanceBase, IPartitionInstance<INode>
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (ShapesLanguage.Instance.ReferenceGeometry_shapes.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.ReferenceGeometry_shapes.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape>(value).ToList();
			AssureNotNull(safeNodes, ShapesLanguage.Instance.ReferenceGeometry_shapes);
			AssureNotNullMembers(safeNodes, ShapesLanguage.Instance.ReferenceGeometry_shapes);
...
/// <exception cref="InvalidValueException">If set to null</exception>
 IShape IShape.SetUuid(string value, INotificationId? notificationId = null) => SetUuid(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (ShapesLanguage.Instance.IShape_fixpoints.EqualsIdentity(feature))
		{
			var safeNodes = ShapesLanguage.Instance.IShape_fixpoints.AsNodes<LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Coord>(value).ToList();
		...
		if (ShapesLanguage.Instance.Shape_shapeDocs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				SetShapeDocs((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value, notificationId);
				return true;
			}

...
public partial class BillOfMaterials : AnnotationInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, IEventId? eventId = null)
	{
		...
		if (ShapesLanguage.Instance.BillOfMaterials_defaultGroup.EqualsIdentity(feature))
		{
			...
			{
				SetDefaultGroup((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MaterialGroup?)value, eventId);
				return true;
			}
...
public partial class Geometry : ConceptInstanceBase, IPartitionInstance<INode>
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, IEventId? eventId = null)
	{
		...
		if (ShapesLanguage.Instance.Geometry_documentation.EqualsIdentity(feature))
		{
			...
			{
				SetDocumentation((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value, eventId);
				return true;
			}
...
public partial class MaterialGroup : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, IEventId? eventId = null)
	{
		...
		if (ShapesLanguage.Instance.MaterialGroup_defaultShape.EqualsIdentity(feature))
		{
			...
			{
				SetDefaultShape((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.IShape?)value, eventId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.MaterialGroup_matterState.EqualsIdentity(feature))
		{
			...
			{
				SetMatterState((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.MatterState?)value, eventId);
				return true;
			}
...
public partial class OffsetDuplicate : Shape
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, IEventId? eventId = null)
	{
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_altSource.EqualsIdentity(feature))
		{
			...
			{
				SetAltSource((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Shape?)value, eventId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_docs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				SetDocs((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value, eventId);
				return true;
			}
		...
		if (ShapesLanguage.Instance.OffsetDuplicate_secretDocs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				SetSecretDocs((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value, eventId);
				return true;
			}
 ...
 IShape IShape.SetUuid(string value, IEventId? eventId = null) => SetUuid(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, IEventId? eventId = null)
	{
		...
		if (ShapesLanguage.Instance.Shape_shapeDocs.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation)
			{
				SetShapeDocs((LionWeb.Integration.Languages.Generated.V2023_1.Shapes.M2.Documentation?)value, eventId);
				return true;
			}

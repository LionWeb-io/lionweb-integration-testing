 ...
 INamedWritable INamedWritable.SetName(string value) => SetName(value);
        ...
        protected override bool SetInternal(Feature? feature, Object? value)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(feature))
		{
			...
			{
				Containment_0_1 = (LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept?)value;
				return true;
			}
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_1.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept)
			{
				Reference_0_1 = (LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept?)value;
				return true;
			}

...
public partial class DataTypeTestConcept : ConceptInstanceBase
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (TestLanguageLanguage.Instance.DataTypeTestConcept_enumValue_0_1.EqualsIdentity(feature))
		{
			...
			{
				SetEnumValue_0_1((LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.TestEnumeration?)value, notificationId);
				return true;
			}
 ...
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(feature))
		{
			...
			{
				SetContainment_0_1((LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept?)value, notificationId);
				return true;
			}
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.LinkTestConcept_containment_0_n.AsNodes<LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept>(value).ToList();
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.LinkTestConcept_containment_1_n.AsNodes<LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept>(value).ToList();
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_1.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept)
			{
				SetReference_0_1((LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept?)value, notificationId);
				return true;
			}
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n.AsReferenceTargets<LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept>(value).ToList();
			AssureNotNull(safeNodes, TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n);
			AssureNotNullMembers(safeNodes, TestLanguageLanguage.Instance.LinkTestConcept_reference_0_n);
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.LinkTestConcept_reference_1_n.AsReferenceTargets<LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept>(value).ToList();
 ...
 INamedWritable INamedWritable.SetName(string value, INotificationId? notificationId = null) => SetName(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, INotificationId? notificationId = null)
	{
		...
		if (TestLanguageLanguage.Instance.TestPartition_data.EqualsIdentity(feature))
		{
			...
			{
				SetData((LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.DataTypeTestConcept?)value, notificationId);
				return true;
			}
		...
		if (TestLanguageLanguage.Instance.TestPartition_links.EqualsIdentity(feature))
		{
			var safeNodes = TestLanguageLanguage.Instance.TestPartition_links.AsNodes<LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept>(value).ToList();

...
public partial class DataTypeTestConcept : ConceptInstanceBase, IPartitionInstance<INode>
{
        ...
        protected override bool SetInternal(Feature? feature, object? value, IEventId? eventId = null)
	{
		...
		if (TestLanguageLanguage.Instance.DataTypeTestConcept_enumValue_0_1.EqualsIdentity(feature))
		{
			...
			{
				SetEnumValue_0_1((LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.TestEnumeration?)value, eventId);
				return true;
			}
 ...
 INamedWritable INamedWritable.SetName(string value, IEventId? eventId = null) => SetName(value);
        ...
        protected override bool SetInternal(Feature? feature, object? value, IEventId? eventId = null)
	{
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_containment_0_1.EqualsIdentity(feature))
		{
			...
			{
				SetContainment_0_1((LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept?)value, eventId);
				return true;
			}
		...
		if (TestLanguageLanguage.Instance.LinkTestConcept_reference_0_1.EqualsIdentity(feature))
		{
			if (value is null or LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept)
			{
				SetReference_0_1((LionWeb.Integration.Languages.Generated.V2024_1.TestLanguage.M2.LinkTestConcept?)value, eventId);
				return true;
			}
